    ...
    organizer: {
      ...
      options: {
        ...
        deletion: {
          ...
          button: t('categories.organizer.options.deleteButton') as string,
          condition: {
    ...
    offer: {
      ...
      options: {
        ...
        deletion: {
          ...
          button: t('categories.offer.options.deleteButton') as string,
        },
      },
    ...
    location: {
      ...
      options: {
        ...
        deletion: {
          ...
          button: t('categories.location.options.deleteButton') as string,
        },
      },
