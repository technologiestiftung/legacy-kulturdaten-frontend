...
export const BodyLock: React.FC<BodyLockProps> = ({ conditions }: BodyLockProps) => {
  const lockBody = useMemo(() => conditions.includes(true), [conditions]);
  ...
  useEffect(() => {
    if (lockBody) {
      ...
      console.log('scrollTo', windowScrollY);
